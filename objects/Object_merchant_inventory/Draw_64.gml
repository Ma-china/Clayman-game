...
draw_rectangle(
	ui_padding_x + ui_border_size + ui_panel_left,
...
draw_set(c_black, 0.5);
draw_text(
	ui_padding_x + ui_panel_left + ui_border_size + ui_inventory_margin + 504,
	ui_padding_y + (ui_border_size * 4) + 4,
	"Money:" + string(global.game_data.money)
);
draw_set(c_white, 1);
draw_text(
	ui_padding_x + ui_panel_left + ui_border_size + ui_inventory_margin + 500,
	ui_padding_y + (ui_border_size * 4),
	"Money:" + string(global.game_data.money)
);
...
inventory_items = global.game_data.inventory.item_get();
